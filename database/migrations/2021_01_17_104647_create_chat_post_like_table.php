...
class CreateChatPostLikeTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        if(!Schema::hasTable('chat_post_like')){
            Schema::create('chat_post_like', function (Blueprint $table) {
                $table->id();
    ...
    {
        Schema::dropIfExists('chat_post_like');
    }
}
