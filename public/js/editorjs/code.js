 ...
 */
        var a = function() {
            function e(t) {
                ...
                this.api = o,
                this.readOnly = a,
                this.placeholder = this.api.i18n.t(r.placeholder || e.DEFAULT_PLACEHOLDER),
                this.CSS = {
            ...
            o(e, [{
                ...
                value: function() {
                    ...
                    return t.classList.add(this.CSS.baseClass, this.CSS.wrapper),
                    n.classList.add(this.CSS.textarea, this.CSS.input),
                    n.textContent = this.data.code,
                    n.placeholder = this.placeholder,
                    this.readOnly && (n.disabled = !0),
                    t.appendChild(n),
                ...
                value: function(e) {
                    ...
                    if (r) {
                        ...
                        if ("  " !== a.substr(i, "  ".length))
                            return;
                        n.value = a.substring(0, i) + a.substring(i + "  ".length),
                        t = o - "  ".length
                    } else
                        t = o + "  ".length,
                        n.value = a.substring(0, o) + "  " + a.substring(o);
                ...
                set: function(e) {
                    this._data = e,
                    this.nodes.textarea && (this.nodes.textarea.textContent = e.code)
                }
            }], [{
                key: "toolbox",
                get: function() {
