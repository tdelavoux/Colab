 ...
 !function(t, e) {
    ...
    , function(t, e, n) {
        ...
        , function(t, e, n) {
            ...
            n(4);
            var o, i, a, s, c, u, l = n(8), f = (i = function(t) {
        ...
        , function(t, e, n) {
            (function(t, e) {
                !function(t, n) {
                    "use strict";
                    if (!t.setImmediate) {
                        var r, o, i, a, s, c = 1, u = {}, l = !1, f = t.document, h = Object.getPrototypeOf && Object.getPrototypeOf(t);
              ...
              , r = function(t, e, o, i) {
                ...
                t ? function(t) {
                    ...
                    "object" == typeof t[a] && null !== t[a])
                        ...
                        e && (c = u,
                        u = !isNaN(parseFloat(c)) && isFinite(c) ? e + Number(u) : u);
                        var l = t[a];
    ...
    , function(t, e, n) {
        ...
        function() {
            ...
            h()(t, [{
                key: "render",
                value: function() {
                    return this.nodes.wrapper = this.make("div", this.CSS.baseClass),
                    this.nodes.container = this.make("div", this.CSS.container),
                    this.nodes.inputHolder = this.makeInputHolder(),
                    this.nodes.linkContent = this.prepareLinkPreview(),
                    Object.keys(this.data.meta).length ? (this.nodes.container.appendChild(this.nodes.linkContent),
                    this.showLinkPreview(this.data.meta)) : this.nodes.container.appendChild(this.nodes.inputHolder),
                ...
                value: function() {
                    ...
                    return this.nodes.progress = this.make("label", this.CSS.progress),
                    ...
                    this.readOnly || (this.nodes.input.addEventListener("paste", (function(e) {
                        t.startFetching(e)
                    }
                    )),
                ...
                value: function(t) {
                    ...
                    "paste" === t.type && (e = (t.clipboardData || window.clipboardData).getData("text")),
                    this.removeErrorStyle(),
                    this.fetchLinkData(e)
                }
            }, {
                ...
                value: function() {
                    ...
                    return this.nodes.linkImage = this.make("div", this.CSS.linkImage),
                ...
                value: function(t) {
                    ...
                    e && e.url && (this.nodes.linkImage.style.backgroundImage = "url(" + e.url + ")",
                    this.nodes.linkContent.appendChild(this.nodes.linkImage)),
                    n && (this.nodes.linkTitle.textContent = n,
                    this.nodes.linkContent.appendChild(this.nodes.linkTitle)),
                    r && (this.nodes.linkDescription.textContent = r,
                ...
                value: function() {
                    ...
                    return new Promise((function(e) {
                        t.nodes.progress.classList.remove(t.CSS.progressLoading),
                        t.nodes.progress.classList.add(t.CSS.progressLoaded),
                        setTimeout(e, 500)
                    }
                    ))
                }
                ...
                key: "make",
                value: function(t) {
                    var e, n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : null, r = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {}, i = document.createElement(t);
